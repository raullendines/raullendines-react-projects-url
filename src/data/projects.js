...
const projects = [
	{
		...
		date: 'Sept 13, 2022',
		img: '@/assets/images/eywa_project/menu_eywa.png',
		projectImages: [
			{
				id: 1,
			...
			},
			{
				...
				img: '@/assets/images/eywa_project/trivia_eywa.png',
			},
			{
				id: 3,
				title: 'Trivia App ScoreBoard',
				img: '@/assets/images/eywa_project/score_eywa.png',
			},
		],
		projectInfo: {
			...
			relatedProjects: [
				{
					id: 1,
					title: 'Mobile UI',
					img: '@/assets/images/eywa_project/eywa.png',
				}
			],
		},
	},
		...
		projectImages: [
			{
				...
				img: '@/assets/images/eywa_project/register_eywa.png',
			},
			{
				id: 2,
				title: 'Trivia Admin Questions',
				img: '@/assets/images/eywa_project/questions_eywa.png',
			},
			{
				id: 3,
				title: 'Trivia Admin Users',
				img: '@/assets/images/eywa_project/users_eywa.png',
			},
		],
		projectInfo: {
			clientHeading: 'About Client',
...

	{
		...
		category: 'Mobile Application',
		img: '@/assets/images/codecrafters_project/panoramic_android.png',
		date: 'Sept 13, 2022',
		projectImages: [
			{
				id: 1,
		...
		projectImages: [
			{
				id: 1,
				title: 'Sign In Form',
				img: '@/assets/images/codecrafters_project/register_sc.png',
			},
			{
				id: 2,
				title: 'Landing Form',
				img: '@/assets/images/codecrafters_project/landing_sc.png',
			},
			{
				id: 3,
				title: 'Users Form',
				img: '@/assets/images/codecrafters_project/users_sc.png',
			},
		],
		projectInfo: {
			clientHeading: 'About Client',
...

	{
		...
		img: '@/assets/images/broggi_project/broggi_image.png',
		date: 'Feb 12, 2022',
		projectImages: [
			{
				id: 1,
				title: 'Expedients Projecte Broggi',
				img: '@/assets/images/broggi_project/expedients_broggi.png',
			},
			{
				id: 2,
				title: 'Trivia Admin Questions',
				img: '@/assets/images/broggi_project/admin_broggi.png',
			},
			{
				id: 3,
				title: 'Trivia Admin Users',
				img: '@/assets/images/broggi_project/formulari_broggi.png',
			},
		],
		projectInfo: {
			clientHeading: 'About Client',
